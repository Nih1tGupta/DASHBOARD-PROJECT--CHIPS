                                        ...
                                        <div class="tab-pane fade" id="v-pills-applications" role="tabpanel">
                                            ...
                                            <div class="d-lg-flex align-items-center justify-content-between">
                                                ...
                                                <div class="mt-2 mt-lg-0">
                                                    <a href="http://bestwpware.com/cdn-cgi/l/email-protection#186f6a79687b777c7d6a6b587f75797174367b7775" class="fs-13 fw-bold text-primary">Contact Us &rarr;</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-components" role="tabpanel">
                                            <div class="row g-4 align-items-center">
                                                ...
                                                <div class="col-xl-4">
                                                    ...
                                                    <div class="mt-4">
                                                        <a href="http://bestwpware.com/cdn-cgi/l/email-protection#7c0b0e1d0c1f1318190e0f3c1b111d1510521f1311" class="fs-13 fw-bold">View all resources on Duralux &rarr;</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="tab-pane fade" id="v-pills-features" role="tabpanel">
                                                    <div class="row g-4 nxl-mega-menu-miscellaneous-features">
                                                        ...
                                                        <div class="col-xxl-3 offset-xxl-1 col-xl-4">
                                                            ...
                                                            <div class="mt-4">
                                                                <a href="http://bestwpware.com/cdn-cgi/l/email-protection#8afdf8ebfae9e5eeeff8f9caede7ebe3e6a4e9e5e7" class="fs-13 fw-bold">View all features on Duralux &rarr;</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="fs-11 text-muted mb-0"><a href="http://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f2939e978adc96979e9e93b29d87869e9d9d99dc919d9f">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="fs-11 text-muted mb-0"><a href="http://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e68194838388c885939283a68993928a89898dc885898b">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                        <a href="javascript:void(0);" class="avatar-text avatar-md">
                                            <i class="feather-chevron-right"></i>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="fs-11 text-muted mb-0"><a href="http://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d3beb2bfb2bdbab6fdb2bda5b6aa93bca6a7bfbcbcb8fdb0bcbe">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                        <a href="javascript:void(0);" class="avatar-text avatar-md">
                                            <i class="feather-chevron-right"></i>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="fs-11 text-muted mb-0"><a href="http://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cba0aea5bfa3e5a3bea5ae8ba4bebfa7a4a4a0e5a8a4a6">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                        <a href="javascript:void(0);" class="avatar-text avatar-md">
                                            <i class="feather-chevron-right"></i>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="fs-11 text-muted mb-0"><a href="http://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="96f7e4f5fefff3b8f5f9f8f3e5d6f9e3e2faf9f9fdb8f5f9fb">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                        <a href="javascript:void(0);" class="avatar-text avatar-md">
                                            <i class="feather-chevron-right"></i>
                    ...
                    <div class="dropdown nxl-h-item">
                        <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                            <img src="{{asset('assets/images/avatar/dummy.jpg');}}" alt="user-image" class="img-fluid user-avtar me-0" />
                        </a>
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    <img src="{{asset('assets/images/avatar/dummy.jpg');}}" alt="user-image" class="img-fluid user-avtar" />
                                    <div>
                            ...
                            <div class="dropdown">
                                <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="dropdown">
                                    <span class="hstack">
                                        ...
                                        @if(auth()->user()->role == 2)
                                            <span class="badge bg-soft-success text-danger ms-1">MEMBER</span>
                                        @endif
                                        @if(auth()->user()->role== 1)
                                            <span class="badge bg-soft-danger text-success ms-1">ADMIN</span>
                                        @endif
                                    </span>
