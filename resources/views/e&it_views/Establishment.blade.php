                        ...
                        <div class="accrodion-grp " data-grp-name="">
                            ...
                            <div class="accrodion active">
                                <div class="accrodion-title" style="margin-top:16px; margin-bottom:16px;">
                                    <h4>Establishment of Software Park in Bhilai-</h4>
                                </div>
                                <div class="accrodion-content" style="">
                                    <div class="inner">

                                        <li> An MoU has been signed between the State Government and STPI for the
                                            establishment of a software park in Bhilai. In which one building and five
                                            acres of land has been given to the state government for the establishment
                                            of STPI. Accordingly, a building has been taken on rent from Municipal
                                            Corporation Bhilai and made available to STPI. At present, STPI's building
                                            rent is reimbursed from this item to Municipal Corporation, Bhilai. This
                                            fare is currently around Rs. 54,280/- per month is paid.
